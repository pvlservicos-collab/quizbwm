    ...
    var DEPS = {
      C: {
        m: { img: 'fotodep6', name: 'Ramon', intro: 'Ramon tinha o mesmo perfil metabólico que você, o cortisol elevado depois de fazer o Desafio 14D destravou e quando ajeitou começou a ter resultado rápidamente,', quote: 'Rotina militar, pouco sono, vida puxada — minha barriga não respondia a nada que eu fazia. Em 14 dias o resultado apareceu.' },
        f: { img: 'fotodep8', name: 'Ellen', intro: 'Ellen tinha o mesmo perfil metabólico que você, o cortisol elevado depois de fazer o Desafio 14D destravou e quando ajeitou começou a ter resultado rápidamente,', quote: 'Sem ganhar peso, minha cintura foi perdendo forma. Comecei o protocolo e em 2 semanas o contorno voltou.' }
      },
      I: {
        m: { img: 'fotodep2', name: 'Victor', intro: 'Victor tinha o mesmo perfil metabólico que você, a insulina desregulada depois de fazer o Desafio 14D destravou e quando ajeitou começou a ter resultado rápidamente,', quote: 'Tinha a pochete há anos. Com o protocolo o abdômen começou a aparecer de verdade — gordura abdominal que nunca tinha saído antes.' },
        f: { img: 'fotodep8', name: 'Ellen', intro: 'Ellen tinha o mesmo perfil metabólico que você, a insulina desregulada depois de fazer o Desafio 14D destravou e quando ajeitou começou a ter resultado rápidamente,', quote: 'Gordura travada nos flancos e na cintura. Em 14 dias vi diferença real onde nunca consegui antes.' }
      },
      F: {
        m: { img: 'fotodep3', name: 'Lucas', intro: 'Lucas tinha o mesmo perfil metabólico que você, a inflamação silenciosa depois de fazer o Desafio 14D destravou e quando ajeitou começou a ter resultado rápidamente,', quote: 'Fiquei mais seco e mais forte sem restrição extrema. Corpo menos inchado, resultado mais limpo em menos de 2 semanas.' },
      ...
      M: {
        m: { img: 'fotodep4', name: 'Rafael', intro: 'Rafael tinha o mesmo perfil metabólico que você, o metabolismo adaptado depois de fazer o Desafio 14D destravou e quando ajeitou começou a ter resultado rápidamente,', quote: 'Passei de 1800 para 2300 kcal e fiquei mais seco. Meu metabolismo estava adaptado e eu não sabia disso.' },
        f: { img: 'fotodep1', name: 'Ingrid', intro: 'Ingrid tinha o mesmo perfil metabólico que você, o metabolismo adaptado depois de fazer o Desafio 14D destravou e quando ajeitou começou a ter resultado rápidamente,', quote: 'Meu corpo não respondia mais a nada. Com o método certo o travamento reverteu completamente em 14 dias.' }
      }
    };
    var QS = [
